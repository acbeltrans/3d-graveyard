...
export const Skeleton = (props) => {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <mesh
        position={nodes.characterSkeleton.position}
        scale={nodes.characterSkeleton.scale}
      >
        ...
        <mesh
          ...
          position={nodes.armLeft.position}
          scale={nodes.armLeft.scale}
        />
        <mesh
          geometry={nodes.armRight.geometry}
          material={nodes.armRight.material}
          position={nodes.armRight.position}
          scale={nodes.armRight.scale}
        />
        <mesh
        ...
        <mesh
          ...
          position={nodes.legLeft.position}
          scale={nodes.legLeft.scale}
        />
        <mesh
          geometry={nodes.legRight.geometry}
          material={nodes.legRight.material}
          position={nodes.legRight.position}
          scale={nodes.legRight.scale}
        />
      </mesh>
    </group>
  )
